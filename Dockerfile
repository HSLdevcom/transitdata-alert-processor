...
COPY --from=BUILD /usr/src/app/target/transitdata-alert-processor-jar-with-dependencies.jar /usr/app/transitdata-alert-processor.jar

ENTRYPOINT ["java", "-jar", "/usr/app/transitdata-alert-processor.jar"]
